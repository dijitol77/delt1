...
int odDriveKnobX = blockA2.getX() + blockA2.getWidth() - odDriveKnobWidth - 10 - 10 - 8 - 1;  // Current X position
int odDriveKnobY = blockA2.getY() + 10 + 30 + 4 + 5 + 2;  // Move an additional 2px down from the current position
