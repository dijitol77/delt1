...
// Align to the top of blockA2 with a small margin and move down by an additional 45px (previous 20px + new 25px)
int odDriveKnobY = blockA2.getY() + 10 + 30 - 15 + 20 + 25;
