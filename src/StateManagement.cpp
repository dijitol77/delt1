...
void StateManagement::getStateInformation (juce::MemoryBlock& destData)
{
    ...
    juce::XmlElement::copyXmlToBinary (*xml, destData); // Call as a static method of juce::XmlElement
}

void StateManagement::setStateInformation (const void* data, int sizeInBytes)
{
    std::unique_ptr<juce::XmlElement> xmlState (juce::XmlElement::getXmlFromBinary (data, sizeInBytes)); // Call as a static method of juce::XmlElement
